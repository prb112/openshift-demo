...
import (
	...
	"github.com/prb112/openshift-demo/operator/external-monitor/internal/controller"
...
func init() {
	...
	utilruntime.Must(externalmonitorocppowerxyzv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4f058e49.external-monitor.ocp-power.xyz",
